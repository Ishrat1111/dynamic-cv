...
$nId =  $_REQUEST['nId'];
$message = "";
$sqlForNews = "select * from news where nId='$nId'";
...
if (isset($_POST['submitComment'])) {
	...
	$date = date("d-m-Y");
	$sqlForComment = " insert into comment (name,message,nId,date) values ('$name','$comment','$nId','$date') ";
...
<html lang="bn">
  <head>
    <meta property="og:url"           content="https://www.newsnationbd.com/single.php?nId=<?php echo $data['nId']; ?>" />
	<meta property="og:type"          content="website" />
	<meta property="og:title"         content="<?php echo $data['tittle']; ?>" />
	<meta property="og:description"   content="24H Online Update" />
	<meta property="og:image"         content="https://www.newsnationbd.com/images/<?php echo $data['img']; ?>" />
		...
		<div class="row">
				...
				<div class="single_content_layout">
					<div class="item feature_news_item">
						<div class="item_img">
							<img  class="img-responsive" src="images/<?php echo $info['img']; ?>" alt="<?php echo $info['newsCatagory']; ?>">
						</div><!--item_img-->
							<div class="item_wrapper">
								...
								<div class="item_meta"><a href="#"><?php echo $info['postDate']; ?>,</a> by:<a href="#"><?php echo $info['postedBy']; ?></a></div>
									...
									<div class="">
										<iframe src="https://www.facebook.com/plugins/share_button.php?href=https%3A%2F%2Fnewsnationbd.com%2Fsingle.php%3FnId%3D<?php echo $nId; ?>&layout=button_count&size=large&mobile_iframe=true&appId=711090262605353&width=84&height=28" width="84" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
										<!-- google plus-->
										<!-- Place this tag where you want the share button to render. -->
										<div class="g-plus" data-action="share" data-height="24" data-href="https://newsnationbd.com/single.php?nId=<?php echo $nId; ?>"></div>
					...
					<div class="ad">
						<img class="img-responsive" src="assets/img/ad10.gif" alt="Advertisement">
					</div>
					...
					<div class="add_a_comment">
						...
						<div class="comment_form">
							<div class="col-xs-8">
		                        ...
		                        <?php 
			                    $sqlForSeeComment = "select * from comment where nId=$nId order by cId desc";
					...
					<div class="single_related_news">
					 <div class="single_media_title"><h2>অন্যান্য খবর</h2></div>
						<div class="media_wrapper">
							<?php 
							$sqlForPhoto = "select * from news where nId != '$nId' order by nId desc limit 3";
	                        $queryForPhoto = mysqli_query($con,$sqlForPhoto);
	                        while($infoMore = mysqli_fetch_array($queryForPhoto)) {
							?>
							<div class="media" style="height: 120px;">
								<div class="media-left">
									<a href="#"><img class="media-object" src="images/<?php echo $infoMore['img']; ?>" alt="<?php echo $infoMore['newsCatagory']; ?>"  height="80" width="80"></a>
								</div><!--media-left-->
...
(function (d, s, id) {
        ...
        js.id = id;
        js.src = "//connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v2.3&appId=275258349782697";
        fjs.parentNode.insertBefore(js, fjs);
    }(document, 'script', 'facebook-jssdk'));
 
function fb_share(dynamic_link,dynamic_title) {
    var app_id = '275258349782697';
